...
if exist "%CTAKES_HOME%\bin\runctakesCPE_CLI.bat" goto okHome
cd ..
set CTAKES_HOME=%cd%
...
cd %CTAKES_HOME%
java  -Dctakes.umlsuser=CHANGE_ME -Dctakes.umlspw=CHANGE_ME -cp "%CTAKES_HOME%\desc\;%CTAKES_HOME%\resources\;%CTAKES_HOME%\lib\*" -Dlog4j.configuration=file:\%CTAKES_HOME%\config\log4j.xml -Xms512M -Xmx3g org.apache.ctakes.core.cpe.CmdLineCpeRunner %CTAKES_HOME%\mednotes\cTakes_CLI.xml
cd %CURRENT_DIR%
:end
ENDLOCAL
